...
// closer-click-push-sw.js (inyectado en el SW de Workbox vía importScripts)
...
// autofirmado impide registrar el SW en headless. Default: mundial.closer.click.
const SITE = process.env.SITE_URL || 'https://mundial.closer.click'
