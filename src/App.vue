    ...
    <header class="scoreboard">
      ...
      <div class="hdr-right">
        ...
        <!-- Botón circular de identidad (siempre visible), a la izquierda de la
             moneda de soporte, igual que en closer.click. -->
        ...
        <closer-click-support href="https://ko-fi.com/closerclick" repo="closerclick/pronostico-mundialista" discord="https://discord.gg/D648uq7cth" :lang="locale"></closer-click-support>
      </div>
    </header>
