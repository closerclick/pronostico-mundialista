...
// Texto corto para compartir en redes sociales
const shareText = 'Mira mi pronóstico del Mundial 2026'
  ...
  <div v-if="open" class="overlay" @click.self="emit('close')">
    <div class="modal">
      ...
      <template v-else>
        ...
        <div class="social" role="group" aria-label="Compartir en redes sociales">
          <button class="ico wa" @click="shareWhatsApp" aria-label="Compartir por WhatsApp" title="WhatsApp">
          ...
          <button class="ico tg" @click="shareTelegram" aria-label="Compartir por Telegram" title="Telegram">
          ...
          <button class="ico x" @click="shareX" aria-label="Compartir en X" title="X">
          ...
          <button class="ico fb" @click="shareFacebook" aria-label="Compartir en Facebook" title="Facebook">
          ...
          <button class="ico ig" @click="shareNative" aria-label="Compartir en Instagram u otras apps" title="Compartir…">
        ...
        <div class="print-row">
          <button class="act-btn print" @click="emit('print', url)">
            <span class="ico">🖨</span> Imprimir
          </button>
          <button class="act-btn pdf" @click="emit('pdf', url)">
            <img src="/pdf.svg" alt="" class="pdf-ico" /> Descargar PDF
          </button>
        </div>
      </template>
    </div>
