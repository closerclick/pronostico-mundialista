...
// ecosistema (@closerclick/closer-click-notifications → createShareReceipts).
//
...
import { createShareReceipts, type ShareReceipts } from '@closerclick/closer-click-notifications'
