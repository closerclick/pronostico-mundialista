// Cliente WebSocket mínimo contra el proxy del ecosistema Closer Click.
//
...
// `../closerclick_messenger/src/stores/threadsStore.js`):
//
//   1. Abrimos un WebSocket a `wss://proxy.closer.click`. El proxy nos
...
// La misma URL que usa el messenger (VITE_WS_URL || wss://proxy.closer.click).
const PROXY_URL: string =
  (import.meta.env.VITE_WS_URL as string | undefined) || 'wss://proxy.closer.click'
