// Cliente del sellador de tiempo (TSA) del ecosistema: signer.closer.click.
//
...
// closer-click-signer como fuente de verdad.
//
...
export const SIGNER_URL = 'https://signer.closer.click'
