// Cliente del relay de resultados oficiales (results.closer.click). Trae el feed
...
export const RESULTS_URL = (import.meta.env.VITE_RESULTS_URL as string | undefined) || 'https://results.closer.click'
