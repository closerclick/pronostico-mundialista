...
// compartido del ecosistema @closerclick/closer-click-tutorial. Explica el menú
...
import { createTutorial, type CloserClickTutorial } from '@closerclick/closer-click-tutorial'
...
let instance: CloserClickTutorial | null = null
